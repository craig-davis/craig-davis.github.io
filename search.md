...
<article class="search" data-search-root data-index-url="{{ '/search-index.json' | relative_url }}">
  <form class="search-form" role="search" data-search-form>
    ...
    <div class="search-form__controls">
      <input id="archive-search" name="q" type="search" autocomplete="off" spellcheck="false" aria-describedby="search-help" placeholder="Try Jeep XJ, woodworking, or JavaScript" autofocus data-search-input>
  ...
  <div class="search-results" aria-labelledby="search-results-title">
    <div class="section-heading">
      ...
      <p class="search-results__status" role="status" aria-live="polite" data-search-status>Loading the archive…</p>
    </div>
